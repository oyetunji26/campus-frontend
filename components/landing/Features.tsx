                        ...
                        <div key={idx} className="feature-card group flex flex-col">
                            ...
                            {feature.isVideo ? (
                                <div className="relative aspect-[4/3] bg-slate-100 rounded-[2.5rem] overflow-hidden mb-10 border border-warm-grey group-hover:shadow-2xl group-hover:shadow-cool-slate/10 transition-all duration-500">
                                    <div className="absolute inset-0 bg-gradient-to-t from-cool-slate/40 to-transparent z-10" />
                                    <div className="absolute inset-0 flex items-center justify-center z-20">
                                        <div className="w-16 h-16 bg-white/90 backdrop-blur rounded-full flex items-center justify-center text-cool-slate shadow-xl cursor-pointer group-hover:scale-110 transition-transform duration-500">
                                    ...
                                    <div className="absolute top-6 left-6 z-20 bg-white/90 backdrop-blur px-4 py-1.5 rounded-full flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-header font-black uppercase tracking-widest text-cool-slate">4K Tour</span>
                                    </div>
                                </div>
                            ) : (
